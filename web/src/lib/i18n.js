...
const dictionaries = {
	id: {
		...
		admin: {
			title: "Admin",
			releaseTitle: "Persiapan rilis 1.0-alpha.2",
			releaseSubtitle: "Checklist cepat untuk menyiapkan rilis alpha berikutnya.",
	...
	en: {
		...
		admin: {
			title: "Admin",
			releaseTitle: "Release 1.0-alpha.2 preparation",
			releaseSubtitle: "Quick release readiness checklist before shipping the next alpha.",
